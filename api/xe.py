...
async def addXe(rq,relative_path,files):
    rs={}
    paramsAccept=['tenXe','hangXe','bienSoXe','loaiXe','giaThue','images','trangThai','moTa']
    ...
    if not checkInvalid(listParams,paramsAccept):
        ...
        try:           
            ...
            if row:
                ...
                params=[rq['tenXe'],rq['hangXe'],rq['trangThai'],rq['bienSoXe'],rq['loaiXe'],rq['giaThue'],rq['moTa'],strListHinhAnh]
                sql="EXEC pr_add_Xe @tenXe=?,@hangXe=?,@trangThai=?,@bienSoXe=?,@loaiXe=?,@giaThue=?,@moTa=?,@listHinhAnh=?"
